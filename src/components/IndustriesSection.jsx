...
const IndustriesSection = () => {
  ...
  return (
    <section className="bg-[#000000] py-20 md:py-28 flex flex-col items-center overflow-hidden">
              ...
              >
                <div className="group relative h-[400px] overflow-hidden bg-gray-200 cursor-pointer">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-20">
                    ...
                    <div className="absolute inset-4 bg-[#0062fe]/90 flex flex-col items-center justify-center p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out">
