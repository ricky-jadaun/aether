    ...
    <section className="bg-white py-20 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/2 text-left">
          <p className="text-[#375ca1] font-semibold tracking-wider uppercase mb-4">
            Achieve More
          </p>
        ...
        <div className="lg:w-1/2 w-full relative">
          ...
          <div className="flex gap-4 mt-6 justify-center md:justify-end ">
            <button
              onClick={prevCard}
              className="p-3 rounded-full border border-gray-200 text-gray-600 hover:bg-[#375ca1] hover:text-white hover:border-[#0062fe] transition-all duration-300 cursor-pointer"
            >
