      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-[1000px] mx-auto px-5 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/contact" className="bg-brand-blue text-white font-bold px-12 py-5 rounded-full hover:bg-brand-orange transition-all shadow-lg hover:shadow-brand-orange/20 text-lg">
              Start Your Project
            </Link>
            <Link to="/about/company-overview" className="bg-white border-2 border-brand-blue text-brand-blue font-bold px-12 py-5 rounded-full hover:bg-brand-blue hover:text-white transition-all text-lg">
              Learn More About Us
            </Link>
          </div>
        </div>
