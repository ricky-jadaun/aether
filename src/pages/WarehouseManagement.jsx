          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-5">
                <Link to="/contact" className="px-12 py-5 bg-brand-blue text-white font-black rounded-xl hover:scale-105 transition-transform shadow-2xl shadow-brand-blue/20">
