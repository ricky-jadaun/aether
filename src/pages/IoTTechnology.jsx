        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 lg:px-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-6">
                <Link to="/contact" className="bg-brand-blue border-2 border-brand-blue text-white font-semibold tracking-wide px-12 py-5 rounded-full hover:bg-transparent hover:text-white transition-all duration-300 shadow-2xl shadow-brand-blue/20">
                    Discover Solutions
                </Link>
