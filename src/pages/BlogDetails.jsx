    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[50vh] min-h-[400px] w-full flex items-end">
        ...
        <div className="relative z-10 max-w-[1000px] mx-auto px-5 pb-16 w-full text-white">
          <Link to="/blogs" className="flex items-center gap-2 text-white/70 hover:text-white mb-8 transition-colors group">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-[1000px] mx-auto px-5 text-center">
          ...
          <Link to="/contact" className="inline-block bg-brand-blue text-white font-bold px-10 py-4 rounded-full hover:bg-brand-orange transition-all shadow-lg hover:shadow-brand-orange/20">
            Speak to an Expert
          </Link>
        </div>
      </section>
