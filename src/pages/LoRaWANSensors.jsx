      ...
      <section className="relative py-14 overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-5 lg:px-10 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <Link to="/contact" className="px-12 py-5 bg-brand-green text-black font-black rounded-full hover:scale-110 transition-transform shadow-2xl shadow-brand-green/20">
                  Deploy Network
                </Link>
