    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          <div>
            ...
            <div className="flex flex-wrap gap-5">
              <Link to="/contact" className="bg-brand-orange text-white font-semibold tracking-wide px-10 py-4 rounded-xl hover:shadow-2xl hover:shadow-brand-orange/30 transition-all flex items-center gap-2">
      ...
      <section className="py-24 max-w-[1400px] mx-auto px-5 lg:px-10">
        <div className="flex flex-col lg:flex-row justify-between items-center mb-16 gap-8">
            ...
            {/* <Link to="/contact" className="text-brand-blue font-bold flex items-center gap-2 group">
      ...
      <section className="py-24 px-5">
         <div className="max-w-[1200px] mx-auto bg-gray-900 rounded-[60px] p-12 md:p-24 text-center relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
                <Link to="/contact" className="bg-brand-blue text-white font-semibold px-12 py-5 tracking-wide rounded-full hover:bg-brand-orange transition-all shadow-2xl shadow-brand-blue/20">
                    Request a Quote
                </Link>
