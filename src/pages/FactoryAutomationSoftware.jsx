          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-6">
                <Link to="/contact" className="px-12 py-5 bg-brand-orange text-black font-black uppercase italic rounded-full hover:scale-105 transition-transform shadow-2xl shadow-brand-orange/20">
