        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-5">
              <Link to="/contact" className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-10 py-4 rounded-2xl transition-all shadow-xl shadow-blue-500/20 flex items-center gap-3">
